...
<Global.System.Data.Linq.Mapping.DatabaseAttribute(Name:="PFIC")>  _
Partial Public Class DataClassesPFICDataContext
  ...
  End Sub
    Partial Private Sub InsertMTREXTRA(instance As PFIC.MTREXTRA)
    End Sub
    Partial Private Sub UpdateMTREXTRA(instance As PFIC.MTREXTRA)
    End Sub
    Partial Private Sub DeleteMTREXTRA(instance As PFIC.MTREXTRA)
    End Sub
    Partial Private Sub InsertMTRL(instance As PFIC.MTRL)
    End Sub
    Partial Private Sub UpdateMTRL(instance As PFIC.MTRL)
    End Sub
    Partial Private Sub DeleteMTRL(instance As PFIC.MTRL)
    End Sub
  #End Region
	
	Public Sub New()
		MyBase.New(Global.GmSupp.My.MySettings.Default.PFICConnectionString, mappingSource)
		OnCreated
	End Sub
	...
	Public ReadOnly Property MTREXTRAs() As System.Data.Linq.Table(Of PFIC.MTREXTRA)
		Get
			Return Me.GetTable(Of PFIC.MTREXTRA)
		End Get
	End Property
	
	Public ReadOnly Property MTRLs() As System.Data.Linq.Table(Of PFIC.MTRL)
		Get
			Return Me.GetTable(Of PFIC.MTRL)
		End Get
	End Property
End Class
