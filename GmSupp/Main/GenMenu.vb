    ...
    Private Sub GenMenu_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Else
            ...
            If {"192.168.10.108", "192.168.51.13"}.Contains(LocalIP) Then
                loginf.UsernameTextBox.Text = "ch.keskesiadis" '"t.andreoglou" '"d.makaridis" ' "th.naris" ' "a.giannikos" ' "m.siopis" '
                loginf.PasswordTextBox.Text = "radrad" '"An@Ti6912" '"Ma@Di55489" '"Na@Th3131" '"Gi@Al5879" '"Si@Ma1891" '"AV$2865" Si@Ma1891
